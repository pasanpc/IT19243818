...
public class User {
	...
	public String updateUser(String userId,String uname, String email, String fname, String lname,String cnumber,String CVV,String expdate,String password)
	{
		 String output = "";
		 try
		 {
			...
			public String readResearchers()
			 {
				 ...
				 while (rs.next())
				 {
					...
					output += "<tr><td><input id='hidItemIDUpdateR' name='hidItemIDUpdateR' type='hidden' value='" + userId
					 ...
					 // buttons
			            output += "<td><input name='btnUpdateR' type='button' value='Update' class=' btnUpdateR btn btn-secondary' data-userid='" + userId + "'></td>"
			            		+ "<td><input name = 'btnRemoveR' type='button' value = 'Remove' "
			            		+ "class = 'btnRemoveR btn btn-danger' data-userid='" + userId + "'>"
			            		+"</td></tr>";
			 }
				 con.close();
	...
	//=============insert Researcher Method===============
		...
		//=============Updating a Researcher Method===============
				...
				public String updateResearcher(String userId,String uname, String email, String fname, String lname,String cnumber,String CVV,String expdate,String password)
				{
					 String output = "";
					 try
					 {
	...
	//==========================Admin=========================================
			...
			public String readAdmins()
			 {
				 ...
				 while (rs.next())
				 {
					...
					output += "<tr><td><input id='hidItemIDUpdateA' name='hidItemIDUpdateA' type='hidden' value='" + userId
					 ...
					 // buttons
			            output += "<td><input name='btnUpdateA' type='button' value='Update' class=' btnUpdateA btn btn-secondary' data-userid='" + userId + "'></td>"
			            		+ "<td><input name = 'btnRemoveA' type='button' value = 'Remove' "
			            		+ "class = 'btnRemoveA btn btn-danger' data-userid='" + userId + "'>"
			            		+"</td></tr>";
			 }
				 con.close();
		...
		public String updateAdmin(String userId,String uname, String email, String fname, String lname,String cnumber,String CVV,String expdate,String password)
		{
			 String output = "";
			 try
			 {
